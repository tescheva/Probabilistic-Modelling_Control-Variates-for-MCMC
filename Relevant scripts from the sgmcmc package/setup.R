...
createSGMCMC = function( logLik, logPrior, dataset, params, stepsize, minibatchSize, seed ) { 
    ...
    # checkTFInstall() 
    #This is the function that caused problems and would not let us run functions.
    #After some analysis we realized, this is not necessary, as we had installed 
    #the right Tensorflow versions by "install_tensorflow(version = "1.13.1")"
